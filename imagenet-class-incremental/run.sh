...
CUDA_VISIBLE_DEVICES=4 python cbf_class_incremental_cosine_imagenet.py \
    ...
    --mr_loss --dist 0.5 --K 2 --lw_mr 1 \
    --cb_finetune \
    --ckp_prefix cbf_seed_1993_rs_ratio_0.0_class_incremental_MR_LFAD_cosine_imagenet \
    2>&1 | tee log_cbf_seed_1993_rs_ratio_0.0_class_incremental_MR_LFAD_cosine_imagenet_nb_cl_fg_50_nb_cl_10_nb_protos_20.txt
